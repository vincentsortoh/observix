"""
Enhanced bootstrap.py with integrated log export functionality
"""
import json
import logging
import os
...
from core.enhanced_tracer import init_tracing, init_tracing_and_logging
...
def bootstrap(
    ...
    if logging_config_dict.get("enabled", True):
        ...
        if log_export_enabled:
            # Use integrated tracing and logging initialization
            ...
            logger.info("Set up logging with trace context (without export)")
...
def setup_all_tracing(
    ...
    loguru integration, and log export based on a configuration file.
